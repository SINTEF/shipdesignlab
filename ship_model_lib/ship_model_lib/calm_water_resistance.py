...
# %% auto 0
__all__ = ['logger', 'ch', 'formatter', 'Numeric', 'GRAVITY', 'KINEMATIC_VISCOSITY_WATER', 'CalmWaterResistanceBase',
           'CalmWaterResistanceBySpeedPowerCurve', 'CalmWaterResistanceBySpeedResistanceCurve', 'kn_to_m_per_s',
           'CalmWaterResistanceHollenbachBase', 'CalmWaterResistanceHollenbachSingleScrewDesignDraft',
           'CalmWaterResistanceHollenbachSingleScrewBallastDraft', 'CalmWaterResistanceHollenbachTwinScrewDesignDraft']
...
from .ship_dimensions import ShipDimensionsHollenbachSingleScrew, ShipDimensionsHollenbachTwinScrew
import numpy as np
...
class CalmWaterResistanceHollenbachSingleScrewDesignDraft(
    ...
    def __init__(
        self,
        ship_dimensions: ShipDimensionsHollenbachSingleScrew
    ):
        super().__init__(
            ship_dimensions
        )
...
class CalmWaterResistanceHollenbachTwinScrewDesignDraft(
    ...
    def __init__(
        self,
        ship_dimensions: ShipDimensionsHollenbachTwinScrew
    ):
        super().__init__(
            ship_dimensions
        )
