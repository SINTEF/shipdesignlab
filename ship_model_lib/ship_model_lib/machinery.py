...
# %% auto 0
__all__ = ['Numeric', 'Point', 'Curve', 'FuelByMassFraction', 'FuelConsumption', 'Emissions', 'EmissionFactor', 'LoadInput',
           'MachineryResult', 'MachinerySystemResult', 'PowerSource', 'PowerSourceWithEfficiency',
           'PowerSourceWithSpecificFuelConsumption', 'PowerLoad', 'MachinerySubsystemSimple', 'MachinerySystem']
