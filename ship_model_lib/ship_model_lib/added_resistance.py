...
# %% auto 0
__all__ = ['Numeric', 'logger', 'ch', 'formatter', 'RHO', 'RHO_AIR', 'GRAVITY', 'AddedResistanceBySeaMarginCurve',
           'PiersonMoskowitzSpectrumITTC1978', 'JONSWAPSpectrumITTC1984', 'get_wave_length', 'get_wave_frequency',
           'AddedResistance', 'AddedResistanceByStaWave2', 'AddedResistanceBySNNM', 'AddedResistanceWindITTC']
